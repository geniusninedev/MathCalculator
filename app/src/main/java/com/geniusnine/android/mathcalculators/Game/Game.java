...
public class Game extends AppCompatActivity {
	...
	public void finishGame(View.OnClickListener onClickListener, Outcome out, int i, String name, String s) {
	...
	public Outcome checkGame() {
		...
		if (call_no == 1) {
			...
			diag.setTitle("\n\n\nEnter Player Name");
			diag.getWindow().setBackgroundDrawableResource(R.color.colorPrimary);
