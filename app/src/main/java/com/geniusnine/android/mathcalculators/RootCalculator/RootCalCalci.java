...
public class RootCalCalci extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        area.add("Select");
        area.add("Root Calculator");
        area.add("Square Root Calculator");
        area.add("Cube Root Calculator");
        ...
        halfLifeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 1) {
                    ...
                    Intent meanHalfLife = new Intent(getApplicationContext(), RootCalculator.class);
                    finish();
                ...
                if (position == 2) {
                    ...
                    Intent meanHalfLife = new Intent(getApplicationContext(), SquareRootCalculator.class);
                    startActivity(meanHalfLife);
                    finish();
                ...
                if (position == 3) {
                    ...
                    Intent meanHalfLife = new Intent(getApplicationContext(), CubeRootCalculator.class);
                    startActivity(meanHalfLife);
                    finish();
