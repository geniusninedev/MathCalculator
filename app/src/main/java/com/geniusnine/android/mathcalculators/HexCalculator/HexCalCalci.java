...
public class HexCalCalci extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hexdecimal_calci);
        ...
        mPagerAdapter = new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            private final String[] mFragmentNames = new String[] {
                    getString(R.string.app_name6),
                    getString(R.string.app_name25)
            };
            @Override
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tabLayouthex);
